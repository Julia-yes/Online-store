...
class Products {
    ...
    getProducts(data) {
        data.forEach((el) => {
            if (this.priceRange.min === -1 || this.priceRange.min > el.price)
                this.priceRange.min = el.price;
            if (this.priceRange.min === -1 || this.priceRange.max < el.price)
                this.priceRange.max = el.price;
            this.products.push({
                brand: el.brand,
